...
//  ETFTrackerMacWidget
//
//  Created by Vadim Semenko on 17/09/25.
//
...
// Исправленные Preview для совместимости с macOS 11.0+
struct ETFTrackerMacWidget_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            ETFTrackerMacWidgetEntryView(entry: MacSimpleEntry(date: Date(), etfData: ETFMacWidgetData.placeholder))
