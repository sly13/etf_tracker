      ...
      <main className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-slate-100 mb-4">
            Мобильное приложение Crypto ETFs
          </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-slate-100">Уведомления</h3>
            <p className="text-gray-600 dark:text-slate-400">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-slate-100">Аналитика</h3>
            <p className="text-gray-600 dark:text-slate-400">
