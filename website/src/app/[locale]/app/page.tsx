        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-slate-100">
              {t('features.realtimeTracking.title')}
            </h3>
            <p className="text-gray-600 dark:text-slate-400">
              {t('features.realtimeTracking.description')}
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-slate-100">{t('features.notifications.title')}</h3>
            <p className="text-gray-600 dark:text-slate-400">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-slate-100">{t('features.analytics.title')}</h3>
            <p className="text-gray-600 dark:text-slate-400">
